...
$file=$_POST["file"];
echo $file;
$sqlMax = "SELECT max(id)from utenti;"; 
$statement = $pdo -> query($sqlMax);
$idUser = $statement->fetch();
...
VALUES ($idUser,:nome,:cognome,:data_di_nascita,:luogo_di_nascita,:email,:qualifica);";
$user = $_POST['username'];
$pass = $_POST['password'];
$nome= $_POST['nome'];
