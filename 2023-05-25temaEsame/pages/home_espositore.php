...
<?php
    ...
    $sql = "SELECT titolo,immagine,stato FROM contributi JOIN espositori ON espositori.id_espositore=contributi.id_espositore JOIN utenti ON contributi.id_espositore=utenti.id  WHERE username=$_SESSION['username'];"; 
